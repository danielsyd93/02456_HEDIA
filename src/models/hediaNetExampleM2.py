...
class DilatedNet(nn.Module):
    def __init__(self, n_steps_past=16, num_inputs=4,
        ...
        self.hidden_units = [h1,h1,h1,h2,h2,h2]
        ...
        self.conv6 = nn.Conv1d(self.hidden_units[3],self.hidden_units[4],kernel_size=2,dilation=self.dilations[4])
        self.conv5 = nn.Conv1d(self.hidden_units[4], 1, kernel_size=2, dilation=self.dilations[5])
