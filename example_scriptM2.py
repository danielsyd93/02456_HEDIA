...
from src.models.hediaNetExampleM2 import DilatedNet
...
data_obj = dataLoader(data_pars, features, n_steps_past=21,
                      n_steps_future=12,
                      allowed_gap=10,
...
config = {
"batch_size": 4, 
"lr": 0.003073078903852849, 
"h1": 32, 
"h2": 128, 
"wd": 0.00011229712622007259
}
