...
from src.models.hediaNetExampleM1 import DilatedNet
...
for i, (train_data, val_data, test_data) in enumerate(zip(train_data_sequence, val_data_sequence, test_data_sequence)):
    ...
    data_obj_hyperOpt = dataLoader(data_pars, features, n_steps_past=32,
                                   n_steps_future=6,
                                   allowed_gap=10,
  ...
  model = DilatedNet(h1=config["h1"],
    ...
    data_obj = dataLoader(data_pars, features, n_steps_past=32,
                          n_steps_future=6,
                          allowed_gap=10,
                          scaler=StandardScaler())
